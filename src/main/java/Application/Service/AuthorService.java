...
public class AuthorService {
    ...
    public List<Author> getAllAuthors() {
        return authorDAO.getAllAuthors(); // Call the getAllAuthors() method from the AuthorDAO class
    }
    /**
    ...
    public Author addAuthor(Author author) {
        return authorDAO.insertAuthor(author); // Call the insertAuthor() method from the AuthorDAO class
    }
}
